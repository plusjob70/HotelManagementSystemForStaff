...
$stmt6 = $db->query("SELECT * FROM customer_log ORDER BY cname");
        ...
        <div class="progress-table-wrap">
            <div class="progress-table">
                ...
                <?php for ($i = 0; $i < count($result6); $i++) { ?>
                    <div class="table-row">
                        <div class="serial"><?= $result6[$i]['code'] ?></div>
                        <div class="serial"><?= $result6[$i]['id'] ?></div>
                        <div class="serial"><?= $result6[$i]['cname'] ?></div>
                        <div class="serial"><?= $result6[$i]['rnumber'] ?></div>
                        <div class="serial"><?= $result6[$i]['phone'] ?></div>
                        <div class="serial"><?= $result6[$i]['checkIn'] ?></div>
                        <div class="serial"><?= $result6[$i]['checkOut'] ?></div>
                    </div>
                <?php } ?>
            </div>
        </div>
