...
$stmt5 = $db->query("SELECT ttime, rnumber, staff_id, tstatus FROM task_log WHERE ttime > DATE_SUB(NOW(), INTERVAL 2 DAY)");
...
<body>
    ...
    <div class="section-top-border">
        <h3 class="mb-30">업무현황</h3>
        <div class="progress-table-wrap">
            <div class="progress-table">
                <div class="table-head">
                    <div class="serial">시간</div>
                    <div class="serial">방번호</div>
                    <div class="serial">담당직원</div>
                    <div class="serial">업무내용</div>
                </div>
                <?php for ($i = 0; $i < count($result5); $i++) { ?>
                    <div class="table-row">
                        <div class="serial"><?= $result5[$i]['ttime'] ?></div>
                        <div class="serial"><?= $result5[$i]['rnumber'] ?></div>
                        <div class="serial"><?= $result5[$i]['staff_id'] ?></div>
                        <div class="serial"><?= $result5[$i]['tstatus'] ?></div>
                    </div>
                <?php } ?>
            </div>
        </div>
