...
<body>
    ...
    <div style='margin-right:100px; margin-left:100px;' class="section-top-border">
        ...
        <h4 class="mb-30">Receptionist</h4>
        <div style='margin-bottom:20px;' class="progress-table-wrap">
            <div class="progress-table">
                ...
                <?php for ($i = 0; $i < count($result2); $i++) { ?>
                    <div class="table-row">
                        ...
                        <div class="country"><?= $result2[$i]['sname'] ?></div>
                        <div class="serial"><?= $result2[$i]['phone'] ?></div>
                    </div>
                <?php } ?>
            </div>
        </div>
        <h4 class="mb-30">Room Keeper</h4>
        <div class="progress-table-wrap">
            <div class="progress-table">
                ...
                <?php for ($i = 0; $i < count($result2_2); $i++) { ?>
                    <div class="table-row">
                        <div class="serial"><?= $result2_2[$i]['id'] ?></div>
                        <div class="country"><?= $result2_2[$i]['sname'] ?></div>
                        <div class="serial"><?= $result2_2[$i]['phone'] ?></div>
                    </div>
                <?php } ?>
            </div>
        </div>
